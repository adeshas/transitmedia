...
class ChangePassword extends MainUsers
{
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("main_users", "main_users", "opwd", "opwd", "opwd", "", 202, 255, 0, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-control");
        $this->NewPassword = new DbField("main_users", "main_users", "npwd", "npwd", "npwd", "", 202, 255, 0, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-control");
        $this->ConfirmPassword = new DbField("main_users", "main_users", "cpwd", "cpwd", "cpwd", "", 202, 255, 0, false, "", false, false, false);
