...
class MainBusesGrid extends MainBuses
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "main_campaigns") {
            $this->exterior_campaign_id->CurrentValue = $this->exterior_campaign_id->getSessionValue();
            $this->interior_campaign_id->CurrentValue = $this->interior_campaign_id->getSessionValue();
        }
        if ($this->number->CurrentValue != "") { // Check field with unique index
