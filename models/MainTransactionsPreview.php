 ...
 * Page class
 */
class MainTransactionsPreview extends MainTransactions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainTransactionsPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "main_campaigns") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=main_campaigns&" . GetForeignKeyUrl("fk_id", $this->campaign_id->QueryStringValue) . "";
        }
        if ($masterTblVar == "y_operators") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=y_operators&" . GetForeignKeyUrl("fk_id", $this->operator_id->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "main_campaigns") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->campaign_id->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "y_operators") {
            $find = "\"operator_id\"=";
            ...
            if ($x !== false) {
                ...
                $val = substr($f, $x);
                $val = $this->unquoteValue($val, "DB");
                 $this->operator_id->setQueryStringValue($val);
            }
        }
    }
