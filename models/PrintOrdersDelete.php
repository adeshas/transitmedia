 ...
 * Page class
 */
class PrintOrdersDelete extends PrintOrders
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrintOrdersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("printorderslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("printorderslist"); // Return to list
                return;
            }
        }
