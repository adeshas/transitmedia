 ...
 * Page class
 */
class PrintOrdersView extends PrintOrders
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrintOrdersView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "printorderslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "printorderslist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "printorderslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("printorderslist"), "", $this->TableVar, true);
        $pageId = "view";
