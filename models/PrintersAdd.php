 ...
 * Page class
 */
class PrintersAdd extends Printers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrintersAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("printerslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "printerslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "printersview") {
    ...
    protected function validateForm()
    {
        ...
        if ($this->passcode->Required) {
            if (!$this->passcode->IsDetailKey && EmptyValue($this->passcode->FormValue)) {
                $this->passcode->addErrorMessage(str_replace("%s", $this->passcode->caption(), $this->passcode->RequiredErrorMessage));
            }
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("printerslist"), "", $this->TableVar, true);
