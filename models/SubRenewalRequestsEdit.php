 ...
 * Page class
 */
class SubRenewalRequestsEdit extends SubRenewalRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubRenewalRequestsEdit";
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->campaign_id->EditValue = HtmlEncode($this->campaign_id->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->campaign_id->FormValue)) {
            $this->campaign_id->addErrorMessage($this->campaign_id->getErrorMessage(false));
        }
