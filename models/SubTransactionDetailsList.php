 ...
 * Page class
 */
class SubTransactionDetailsList extends SubTransactionDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubTransactionDetailsList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fsub_transaction_detailslist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "subtransactiondetailsdelete";
        $this->MultiUpdateUrl = "subtransactiondetailsupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fsub_transaction_detailslistsrch";
        ...
        if (!$this->isGridAdd() && !$this->isGridEdit()) { // Not grid add/edit mode
            ...
            foreach ($this->ListActions->Items as $listaction) {
                if ($listaction->Select == ACTION_MULTIPLE) {
                    ...
                    $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fsub_transaction_detailslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function addRow($rsold = null)
    {
        ...
        // transaction_id
        $this->transaction_id->setDbValueDef($rsnew, $this->transaction_id->CurrentValue, 0, false);
