 ...
 * Page class
 */
class SubTransactionDetailsPreview extends SubTransactionDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubTransactionDetailsPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "main_buses") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=main_buses&" . GetForeignKeyUrl("fk_id", $this->bus_id->QueryStringValue) . "";
        }
        if ($masterTblVar == "main_transactions") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=main_transactions&" . GetForeignKeyUrl("fk_id", $this->transaction_id->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "main_buses") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->bus_id->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "main_transactions") {
            $find = "\"transaction_id\"=";
