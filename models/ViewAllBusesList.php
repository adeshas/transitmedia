 ...
 * Page class
 */
class ViewAllBusesList extends ViewAllBuses
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'view_all_buses';

    // Page object name
    public $PageObjName = "ViewAllBusesList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fview_all_buseslist";
    ...
    public function __construct()
    {
        ...
        // Table object (view_all_buses)
        if (!isset($GLOBALS["view_all_buses"]) || get_class($GLOBALS["view_all_buses"]) == PROJECT_NAMESPACE . "view_all_buses") {
            $GLOBALS["view_all_buses"] = &$this;
        }
        ...
        $this->AddUrl = "viewallbusesadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "viewallbusesdelete";
        $this->MultiUpdateUrl = "viewallbusesupdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'view_all_buses');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fview_all_buseslistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_all_buses"));
                $doc->Text = @$content;
    ...
    public function run()
    {
        ...
        $this->exterior_campaign->setVisibility();
        $this->exterior_campaign_vendor->setVisibility();
        $this->interior_campaign->setVisibility();
        $this->interior_campaign_vendor->setVisibility();
        $this->bus_status->setVisibility();
        $this->bus_size->setVisibility();
        $this->bus_depot->setVisibility();
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->exterior_campaign->AdvancedSearch->toJson(), ","); // Field exterior_campaign
        $filterList = Concat($filterList, $this->exterior_campaign_vendor->AdvancedSearch->toJson(), ","); // Field exterior_campaign_vendor
        $filterList = Concat($filterList, $this->interior_campaign->AdvancedSearch->toJson(), ","); // Field interior_campaign
        $filterList = Concat($filterList, $this->interior_campaign_vendor->AdvancedSearch->toJson(), ","); // Field interior_campaign_vendor
        $filterList = Concat($filterList, $this->bus_status->AdvancedSearch->toJson(), ","); // Field bus_status
        $filterList = Concat($filterList, $this->bus_size->AdvancedSearch->toJson(), ","); // Field bus_size
        $filterList = Concat($filterList, $this->bus_depot->AdvancedSearch->toJson(), ","); // Field bus_depot
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fview_all_buseslistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field exterior_campaign
        $this->exterior_campaign->AdvancedSearch->SearchValue = @$filter["x_exterior_campaign"];
        $this->exterior_campaign->AdvancedSearch->SearchOperator = @$filter["z_exterior_campaign"];
        $this->exterior_campaign->AdvancedSearch->SearchCondition = @$filter["v_exterior_campaign"];
        $this->exterior_campaign->AdvancedSearch->SearchValue2 = @$filter["y_exterior_campaign"];
        $this->exterior_campaign->AdvancedSearch->SearchOperator2 = @$filter["w_exterior_campaign"];
        $this->exterior_campaign->AdvancedSearch->save();

        // Field exterior_campaign_vendor
        $this->exterior_campaign_vendor->AdvancedSearch->SearchValue = @$filter["x_exterior_campaign_vendor"];
        $this->exterior_campaign_vendor->AdvancedSearch->SearchOperator = @$filter["z_exterior_campaign_vendor"];
        $this->exterior_campaign_vendor->AdvancedSearch->SearchCondition = @$filter["v_exterior_campaign_vendor"];
        $this->exterior_campaign_vendor->AdvancedSearch->SearchValue2 = @$filter["y_exterior_campaign_vendor"];
        $this->exterior_campaign_vendor->AdvancedSearch->SearchOperator2 = @$filter["w_exterior_campaign_vendor"];
        $this->exterior_campaign_vendor->AdvancedSearch->save();

        // Field interior_campaign
        $this->interior_campaign->AdvancedSearch->SearchValue = @$filter["x_interior_campaign"];
        $this->interior_campaign->AdvancedSearch->SearchOperator = @$filter["z_interior_campaign"];
        $this->interior_campaign->AdvancedSearch->SearchCondition = @$filter["v_interior_campaign"];
        $this->interior_campaign->AdvancedSearch->SearchValue2 = @$filter["y_interior_campaign"];
        $this->interior_campaign->AdvancedSearch->SearchOperator2 = @$filter["w_interior_campaign"];
        $this->interior_campaign->AdvancedSearch->save();

        // Field interior_campaign_vendor
        $this->interior_campaign_vendor->AdvancedSearch->SearchValue = @$filter["x_interior_campaign_vendor"];
        $this->interior_campaign_vendor->AdvancedSearch->SearchOperator = @$filter["z_interior_campaign_vendor"];
        $this->interior_campaign_vendor->AdvancedSearch->SearchCondition = @$filter["v_interior_campaign_vendor"];
        $this->interior_campaign_vendor->AdvancedSearch->SearchValue2 = @$filter["y_interior_campaign_vendor"];
        $this->interior_campaign_vendor->AdvancedSearch->SearchOperator2 = @$filter["w_interior_campaign_vendor"];
        $this->interior_campaign_vendor->AdvancedSearch->save();

        // Field bus_status
        $this->bus_status->AdvancedSearch->SearchValue = @$filter["x_bus_status"];
        $this->bus_status->AdvancedSearch->SearchOperator = @$filter["z_bus_status"];
        $this->bus_status->AdvancedSearch->SearchCondition = @$filter["v_bus_status"];
        $this->bus_status->AdvancedSearch->SearchValue2 = @$filter["y_bus_status"];
        $this->bus_status->AdvancedSearch->SearchOperator2 = @$filter["w_bus_status"];
        $this->bus_status->AdvancedSearch->save();
        ...
        // Field bus_depot
        $this->bus_depot->AdvancedSearch->SearchValue = @$filter["x_bus_depot"];
        $this->bus_depot->AdvancedSearch->SearchOperator = @$filter["z_bus_depot"];
        $this->bus_depot->AdvancedSearch->SearchCondition = @$filter["v_bus_depot"];
        $this->bus_depot->AdvancedSearch->SearchValue2 = @$filter["y_bus_depot"];
        $this->bus_depot->AdvancedSearch->SearchOperator2 = @$filter["w_bus_depot"];
        $this->bus_depot->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->exterior_campaign, $default, false); // exterior_campaign
        $this->buildSearchSql($where, $this->exterior_campaign_vendor, $default, false); // exterior_campaign_vendor
        $this->buildSearchSql($where, $this->interior_campaign, $default, false); // interior_campaign
        $this->buildSearchSql($where, $this->interior_campaign_vendor, $default, false); // interior_campaign_vendor
        $this->buildSearchSql($where, $this->bus_status, $default, false); // bus_status
        $this->buildSearchSql($where, $this->bus_size, $default, false); // bus_size
        $this->buildSearchSql($where, $this->bus_depot, $default, false); // bus_depot
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->exterior_campaign->AdvancedSearch->save(); // exterior_campaign
            $this->exterior_campaign_vendor->AdvancedSearch->save(); // exterior_campaign_vendor
            $this->interior_campaign->AdvancedSearch->save(); // interior_campaign
            $this->interior_campaign_vendor->AdvancedSearch->save(); // interior_campaign_vendor
            $this->bus_status->AdvancedSearch->save(); // bus_status
            $this->bus_size->AdvancedSearch->save(); // bus_size
            $this->bus_depot->AdvancedSearch->save(); // bus_depot
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->exterior_campaign, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->exterior_campaign_vendor, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->interior_campaign, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->interior_campaign_vendor, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->bus_status, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->bus_size, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->bus_depot, $arKeywords, $type);
        return $where;
    }
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->exterior_campaign->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->exterior_campaign_vendor->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->interior_campaign->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->interior_campaign_vendor->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->bus_status->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->bus_size->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->bus_depot->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->exterior_campaign->AdvancedSearch->unsetSession();
                $this->exterior_campaign_vendor->AdvancedSearch->unsetSession();
                $this->interior_campaign->AdvancedSearch->unsetSession();
                $this->interior_campaign_vendor->AdvancedSearch->unsetSession();
                $this->bus_status->AdvancedSearch->unsetSession();
                $this->bus_size->AdvancedSearch->unsetSession();
                $this->bus_depot->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        // Restore advanced search values
                ...
                $this->exterior_campaign->AdvancedSearch->load();
                $this->exterior_campaign_vendor->AdvancedSearch->load();
                $this->interior_campaign->AdvancedSearch->load();
                $this->interior_campaign_vendor->AdvancedSearch->load();
                $this->bus_status->AdvancedSearch->load();
                $this->bus_size->AdvancedSearch->load();
                $this->bus_depot->AdvancedSearch->load();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->exterior_campaign); // exterior_campaign
            $this->updateSort($this->exterior_campaign_vendor); // exterior_campaign_vendor
            $this->updateSort($this->interior_campaign); // interior_campaign
            $this->updateSort($this->interior_campaign_vendor); // interior_campaign_vendor
            $this->updateSort($this->bus_status); // bus_status
            $this->updateSort($this->bus_size); // bus_size
            $this->updateSort($this->bus_depot); // bus_depot
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->exterior_campaign->setSort("");
                $this->exterior_campaign_vendor->setSort("");
                $this->interior_campaign->setSort("");
                $this->interior_campaign_vendor->setSort("");
                $this->bus_status->setSort("");
                $this->bus_size->setSort("");
                $this->bus_depot->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_all_buseslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_all_buseslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fview_all_buseslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function loadSearchValues()
    {
        ...
        // exterior_campaign
        if (!$this->isAddOrEdit() && $this->exterior_campaign->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->exterior_campaign->AdvancedSearch->SearchValue != "" || $this->exterior_campaign->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // exterior_campaign_vendor
        if (!$this->isAddOrEdit() && $this->exterior_campaign_vendor->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->exterior_campaign_vendor->AdvancedSearch->SearchValue != "" || $this->exterior_campaign_vendor->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // interior_campaign
        if (!$this->isAddOrEdit() && $this->interior_campaign->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->interior_campaign->AdvancedSearch->SearchValue != "" || $this->interior_campaign->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // interior_campaign_vendor
        if (!$this->isAddOrEdit() && $this->interior_campaign_vendor->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->interior_campaign_vendor->AdvancedSearch->SearchValue != "" || $this->interior_campaign_vendor->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // bus_status
        if (!$this->isAddOrEdit() && $this->bus_status->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->bus_status->AdvancedSearch->SearchValue != "" || $this->bus_status->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // bus_depot
        if (!$this->isAddOrEdit() && $this->bus_depot->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->bus_depot->AdvancedSearch->SearchValue != "" || $this->bus_depot->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    protected function newRow()
    {
        ...
        $row['platform'] = null;
        $row['operator'] = null;
        $row['exterior_campaign'] = null;
        $row['exterior_campaign_vendor'] = null;
        $row['interior_campaign'] = null;
        $row['interior_campaign_vendor'] = null;
        $row['bus_status'] = null;
        $row['bus_size'] = null;
        $row['bus_depot'] = null;
        $row['ts_created'] = null;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->exterior_campaign->EditValue = HtmlEncode($this->exterior_campaign->AdvancedSearch->SearchValue);
            ...
            if (!$this->exterior_campaign_vendor->Raw) {
                $this->exterior_campaign_vendor->AdvancedSearch->SearchValue = HtmlDecode($this->exterior_campaign_vendor->AdvancedSearch->SearchValue);
            }
            $this->exterior_campaign_vendor->EditValue = HtmlEncode($this->exterior_campaign_vendor->AdvancedSearch->SearchValue);
            ...
            $this->interior_campaign->EditValue = HtmlEncode($this->interior_campaign->AdvancedSearch->SearchValue);
            ...
            if (!$this->interior_campaign_vendor->Raw) {
                $this->interior_campaign_vendor->AdvancedSearch->SearchValue = HtmlDecode($this->interior_campaign_vendor->AdvancedSearch->SearchValue);
            }
            $this->interior_campaign_vendor->EditValue = HtmlEncode($this->interior_campaign_vendor->AdvancedSearch->SearchValue);
            ...
            if (!$this->bus_status->Raw) {
                $this->bus_status->AdvancedSearch->SearchValue = HtmlDecode($this->bus_status->AdvancedSearch->SearchValue);
            }
            $this->bus_status->EditValue = HtmlEncode($this->bus_status->AdvancedSearch->SearchValue);
            ...
            $this->bus_depot->EditValue = HtmlEncode($this->bus_depot->AdvancedSearch->SearchValue);
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fview_all_buseslist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fview_all_buseslist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fview_all_buseslist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_view_all_buses" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_view_all_buses\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fview_all_buseslist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_all_buseslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
