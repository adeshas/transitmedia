...
/**
 * Table class for view_bus_depot_summary
 */
class ViewBusDepotSummary extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_bus_depot_summary';
        $this->TableName = 'view_bus_depot_summary';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_bus_depot_summary\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_bus_depot_summary\"";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->depot->DbValue = $row['depot'];
        $this->total_buses->DbValue = $row['total_buses'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("viewbusdepotsummarylist");
    }
    ...
    {
        global $Language;
        if ($pageName == "viewbusdepotsummaryview") {
            return $Language->phrase("View");
        } elseif ($pageName == "viewbusdepotsummaryedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "viewbusdepotsummaryadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewBusDepotSummaryView";
            case Config("API_ADD_ACTION"):
                return "ViewBusDepotSummaryAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewBusDepotSummaryEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewBusDepotSummaryDelete";
            case Config("API_LIST_ACTION"):
                return "ViewBusDepotSummaryList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("viewbusdepotsummaryview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("viewbusdepotsummaryview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "viewbusdepotsummaryadd?" . $this->getUrlParm($parm);
        } else {
            $url = "viewbusdepotsummaryadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewbusdepotsummaryedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewbusdepotsummaryadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("viewbusdepotsummarydelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        // depot
        $this->depot->EditAttrs["class"] = "form-control";
        $this->depot->EditCustomAttributes = "";
        $this->depot->EditValue = $this->depot->CurrentValue;
        $this->depot->PlaceHolder = RemoveHtml($this->depot->caption());

        // total_buses
        $this->total_buses->EditAttrs["class"] = "form-control";
        $this->total_buses->EditCustomAttributes = "";
        $this->total_buses->EditValue = $this->total_buses->CurrentValue;
        $this->total_buses->PlaceHolder = RemoveHtml($this->total_buses->caption());
