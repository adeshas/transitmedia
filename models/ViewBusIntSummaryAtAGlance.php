...
/**
 * Table class for view_bus_int_summary_at_a_glance
 */
class ViewBusIntSummaryAtAGlance extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_bus_int_summary_at_a_glance';
        $this->TableName = 'view_bus_int_summary_at_a_glance';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_bus_int_summary_at_a_glance\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // brand_status
        $this->brand_status = new DbField('view_bus_int_summary_at_a_glance', 'view_bus_int_summary_at_a_glance', 'x_brand_status', 'brand_status', '"brand_status"', '"brand_status"', 201, 0, -1, false, '"brand_status"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // active
        $this->active = new DbField('view_bus_int_summary_at_a_glance', 'view_bus_int_summary_at_a_glance', 'x_active', 'active', '"active"', 'CAST("active" AS varchar(255))', 20, 8, -1, false, '"active"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // maintenance
        $this->maintenance = new DbField('view_bus_int_summary_at_a_glance', 'view_bus_int_summary_at_a_glance', 'x_maintenance', 'maintenance', '"maintenance"', 'CAST("maintenance" AS varchar(255))', 20, 8, -1, false, '"maintenance"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // total
        $this->total = new DbField('view_bus_int_summary_at_a_glance', 'view_bus_int_summary_at_a_glance', 'x_total', 'total', '"total"', 'CAST("total" AS varchar(255))', 20, 8, -1, false, '"total"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // last_updated_at
        $this->last_updated_at = new DbField('view_bus_int_summary_at_a_glance', 'view_bus_int_summary_at_a_glance', 'x_last_updated_at', 'last_updated_at', '"last_updated_at"', '"last_updated_at"', 201, 0, -1, false, '"last_updated_at"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // platform_id
        $this->platform_id = new DbField('view_bus_int_summary_at_a_glance', 'view_bus_int_summary_at_a_glance', 'x_platform_id', 'platform_id', '"platform_id"', 'CAST("platform_id" AS varchar(255))', 3, 4, -1, false, '"platform_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // operator_id
        $this->operator_id = new DbField('view_bus_int_summary_at_a_glance', 'view_bus_int_summary_at_a_glance', 'x_operator_id', 'operator_id', '"operator_id"', 'CAST("operator_id" AS varchar(255))', 3, 4, -1, false, '"operator_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_bus_int_summary_at_a_glance\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("viewbusintsummaryataglancelist");
    }
    ...
    {
        global $Language;
        if ($pageName == "viewbusintsummaryataglanceview") {
            return $Language->phrase("View");
        } elseif ($pageName == "viewbusintsummaryataglanceedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "viewbusintsummaryataglanceadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewBusIntSummaryAtAGlanceView";
            case Config("API_ADD_ACTION"):
                return "ViewBusIntSummaryAtAGlanceAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewBusIntSummaryAtAGlanceEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewBusIntSummaryAtAGlanceDelete";
            case Config("API_LIST_ACTION"):
                return "ViewBusIntSummaryAtAGlanceList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("viewbusintsummaryataglanceview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("viewbusintsummaryataglanceview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "viewbusintsummaryataglanceadd?" . $this->getUrlParm($parm);
        } else {
            $url = "viewbusintsummaryataglanceadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewbusintsummaryataglanceedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewbusintsummaryataglanceadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("viewbusintsummaryataglancedelete", $this->getUrlParm());
    }
