 ...
 * Page class
 */
class ViewBusSummaryList extends ViewBusSummary
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'view_bus_summary';

    // Page object name
    public $PageObjName = "ViewBusSummaryList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fview_bus_summarylist";
    ...
    public function __construct()
    {
        ...
        // Table object (view_bus_summary)
        if (!isset($GLOBALS["view_bus_summary"]) || get_class($GLOBALS["view_bus_summary"]) == PROJECT_NAMESPACE . "view_bus_summary") {
            $GLOBALS["view_bus_summary"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'view_bus_summary');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fview_bus_summarylistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_bus_summary"));
                $doc->Text = @$content;
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->period->setSort("");
                $this->buses->setSort("");
                $this->active_working->setSort("");
                $this->requires_maintenance->setSort("");
                $this->issues->setSort("");
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fview_bus_summarylist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function newRow()
    {
        ...
        $row['period'] = null;
        $row['buses'] = null;
        $row['active_working'] = null;
        $row['requires_maintenance'] = null;
        $row['issues'] = null;
