...
/**
 * Table class for view_buses_assigned
 */
class ViewBusesAssigned extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_buses_assigned';
        $this->TableName = 'view_buses_assigned';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_buses_assigned\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // transaction_id
        $this->transaction_id = new DbField('view_buses_assigned', 'view_buses_assigned', 'x_transaction_id', 'transaction_id', '"transaction_id"', 'CAST("transaction_id" AS varchar(255))', 3, 4, -1, false, '"transaction_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "view_campaigns_pending") {
            if ($this->transaction_id->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("\"transaction_id\"", $this->transaction_id->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_view_campaigns_pending()
    {
        return "\"transaction_id\"=@transaction_id@";
    }
    // Detail filter
    public function sqlDetailFilter_view_campaigns_pending()
    {
        return "\"transaction_id\"=@transaction_id@";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_buses_assigned\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("viewbusesassignedlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "viewbusesassignedview") {
            return $Language->phrase("View");
        } elseif ($pageName == "viewbusesassignededit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "viewbusesassignedadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewBusesAssignedView";
            case Config("API_ADD_ACTION"):
                return "ViewBusesAssignedAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewBusesAssignedEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewBusesAssignedDelete";
            case Config("API_LIST_ACTION"):
                return "ViewBusesAssignedList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("viewbusesassignedview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("viewbusesassignedview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "viewbusesassignedadd?" . $this->getUrlParm($parm);
        } else {
            $url = "viewbusesassignedadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewbusesassignededit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewbusesassignedadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("viewbusesassigneddelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->bus->EditValue = $this->bus->CurrentValue;
