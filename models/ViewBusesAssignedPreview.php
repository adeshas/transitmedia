 ...
 * Page class
 */
class ViewBusesAssignedPreview extends ViewBusesAssigned
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewBusesAssignedPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_campaigns_pending") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_campaigns_pending&" . GetForeignKeyUrl("fk_transaction_id", $this->transaction_id->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "view_campaigns_pending") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->transaction_id->setQueryStringValue($val);
            }
        }
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("viewbusesassignedlist"), "", $this->TableVar, true);
        $pageId = "preview";
