...
/**
 * Table class for view_buses_external
 */
class ViewBusesExternal extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_buses_external';
        $this->TableName = 'view_buses_external';
        $this->TableType = 'VIEW';
        ...
        // id
        $this->id = new DbField('view_buses_external', 'view_buses_external', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'NO');
        $this->id->Sortable = true; // Allow sort
        $this->id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['id'] = &$this->id;

        // number
        $this->number = new DbField('view_buses_external', 'view_buses_external', 'x_number', 'number', '"number"', '"number"', 200, 0, -1, false, '"number"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->number->Sortable = true; // Allow sort
        $this->Fields['number'] = &$this->number;

        // platform_id
        $this->platform_id = new DbField('view_buses_external', 'view_buses_external', 'x_platform_id', 'platform_id', '"platform_id"', 'CAST("platform_id" AS varchar(255))', 3, 4, -1, false, '"platform_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // operator_id
        $this->operator_id = new DbField('view_buses_external', 'view_buses_external', 'x_operator_id', 'operator_id', '"operator_id"', 'CAST("operator_id" AS varchar(255))', 3, 4, -1, false, '"operator_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->exterior_campaign_id = new DbField('view_buses_external', 'view_buses_external', 'x_exterior_campaign_id', 'exterior_campaign_id', '"exterior_campaign_id"', 'CAST("exterior_campaign_id" AS varchar(255))', 3, 4, -1, false, '"exterior_campaign_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // bus_status_id
        $this->bus_status_id = new DbField('view_buses_external', 'view_buses_external', 'x_bus_status_id', 'bus_status_id', '"bus_status_id"', 'CAST("bus_status_id" AS varchar(255))', 3, 4, -1, false, '"bus_status_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // bus_depot_id
        $this->bus_depot_id = new DbField('view_buses_external', 'view_buses_external', 'x_bus_depot_id', 'bus_depot_id', '"bus_depot_id"', 'CAST("bus_depot_id" AS varchar(255))', 3, 4, -1, false, '"bus_depot_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ts_created
        $this->ts_created = new DbField('view_buses_external', 'view_buses_external', 'x_ts_created', 'ts_created', '"ts_created"', CastDateFieldForLike("\"ts_created\"", 0, "DB"), 135, 8, 0, false, '"ts_created"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ts_last_update
        $this->ts_last_update = new DbField('view_buses_external', 'view_buses_external', 'x_ts_last_update', 'ts_last_update', '"ts_last_update"', CastDateFieldForLike("\"ts_last_update\"", 0, "DB"), 135, 8, 0, false, '"ts_last_update"', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_buses_external\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("viewbusesexternallist");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "viewbusesexternalview") {
            return $Language->phrase("View");
        } elseif ($pageName == "viewbusesexternaledit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "viewbusesexternaladd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewBusesExternalView";
            case Config("API_ADD_ACTION"):
                return "ViewBusesExternalAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewBusesExternalEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewBusesExternalDelete";
            case Config("API_LIST_ACTION"):
                return "ViewBusesExternalList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("viewbusesexternalview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("viewbusesexternalview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "viewbusesexternaladd?" . $this->getUrlParm($parm);
        } else {
            $url = "viewbusesexternaladd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewbusesexternaledit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewbusesexternaladd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("viewbusesexternaldelete", $this->getUrlParm());
    }
