...
/**
 * Table class for view_buses_interior
 */
class ViewBusesInterior extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_buses_interior';
        $this->TableName = 'view_buses_interior';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_buses_interior\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_buses_interior', 'view_buses_interior', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'NO');
        $this->id->Sortable = true; // Allow sort
        $this->id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['id'] = &$this->id;

        // number
        $this->number = new DbField('view_buses_interior', 'view_buses_interior', 'x_number', 'number', '"number"', '"number"', 200, 0, -1, false, '"number"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->number->Sortable = true; // Allow sort
        $this->Fields['number'] = &$this->number;

        // platform_id
        $this->platform_id = new DbField('view_buses_interior', 'view_buses_interior', 'x_platform_id', 'platform_id', '"platform_id"', 'CAST("platform_id" AS varchar(255))', 3, 4, -1, false, '"platform_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // operator_id
        $this->operator_id = new DbField('view_buses_interior', 'view_buses_interior', 'x_operator_id', 'operator_id', '"operator_id"', 'CAST("operator_id" AS varchar(255))', 3, 4, -1, false, '"operator_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->interior_campaign_id = new DbField('view_buses_interior', 'view_buses_interior', 'x_interior_campaign_id', 'interior_campaign_id', '"interior_campaign_id"', 'CAST("interior_campaign_id" AS varchar(255))', 3, 4, -1, false, '"interior_campaign_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // bus_status_id
        $this->bus_status_id = new DbField('view_buses_interior', 'view_buses_interior', 'x_bus_status_id', 'bus_status_id', '"bus_status_id"', 'CAST("bus_status_id" AS varchar(255))', 3, 4, -1, false, '"bus_status_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // bus_depot_id
        $this->bus_depot_id = new DbField('view_buses_interior', 'view_buses_interior', 'x_bus_depot_id', 'bus_depot_id', '"bus_depot_id"', 'CAST("bus_depot_id" AS varchar(255))', 3, 4, -1, false, '"bus_depot_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ts_created
        $this->ts_created = new DbField('view_buses_interior', 'view_buses_interior', 'x_ts_created', 'ts_created', '"ts_created"', CastDateFieldForLike("\"ts_created\"", 0, "DB"), 135, 8, 0, false, '"ts_created"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ts_last_update
        $this->ts_last_update = new DbField('view_buses_interior', 'view_buses_interior', 'x_ts_last_update', 'ts_last_update', '"ts_last_update"', CastDateFieldForLike("\"ts_last_update\"", 0, "DB"), 135, 8, 0, false, '"ts_last_update"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // vendor_id
        $this->vendor_id = new DbField('view_buses_interior', 'view_buses_interior', 'x_vendor_id', 'vendor_id', '"vendor_id"', 'CAST("vendor_id" AS varchar(255))', 3, 4, -1, false, '"vendor_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // campaign_id
        $this->campaign_id = new DbField('view_buses_interior', 'view_buses_interior', 'x_campaign_id', 'campaign_id', '"campaign_id"', 'CAST("campaign_id" AS varchar(255))', 3, 4, -1, false, '"campaign_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_buses_interior\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("viewbusesinteriorlist");
        }
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewBusesInteriorView";
            case Config("API_ADD_ACTION"):
                return "ViewBusesInteriorAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewBusesInteriorEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewBusesInteriorDelete";
...
SORTHTML;
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM \"view_buses_interior\"";
