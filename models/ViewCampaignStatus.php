...
/**
 * Table class for view_campaign_status
 */
class ViewCampaignStatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_campaign_status';
        $this->TableName = 'view_campaign_status';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_campaign_status\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_campaign_status\"";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->denied->DbValue = $row['denied'];
        $this->status->DbValue = $row['status'];
        $this->status_matrix->DbValue = $row['status_matrix'];
        $this->status_json->DbValue = $row['status_json'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("viewcampaignstatuslist");
        }
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewCampaignStatusView";
            case Config("API_ADD_ACTION"):
                return "ViewCampaignStatusAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewCampaignStatusEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewCampaignStatusDelete";
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // status_matrix
        $this->status_matrix->ViewValue = $this->status_matrix->CurrentValue;
        $this->status_matrix->ViewCustomAttributes = "";

        // status_json
        $this->status_json->ViewValue = $this->status_json->CurrentValue;
        $this->status_json->ViewCustomAttributes = "";
        ...
        // status_matrix
        $this->status_matrix->LinkCustomAttributes = "";
        $this->status_matrix->HrefValue = "";
        $this->status_matrix->TooltipValue = "";

        // status_json
        $this->status_json->LinkCustomAttributes = "";
        $this->status_json->HrefValue = "";
        $this->status_json->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // denied
        $this->denied->EditAttrs["class"] = "form-control";
        $this->denied->EditCustomAttributes = "";
        $this->denied->EditValue = $this->denied->CurrentValue;
        $this->denied->PlaceHolder = RemoveHtml($this->denied->caption());
        ...
        // status_matrix
        $this->status_matrix->EditAttrs["class"] = "form-control";
        $this->status_matrix->EditCustomAttributes = "";
        $this->status_matrix->EditValue = $this->status_matrix->CurrentValue;
        $this->status_matrix->PlaceHolder = RemoveHtml($this->status_matrix->caption());

        // status_json
        $this->status_json->EditAttrs["class"] = "form-control";
        $this->status_json->EditCustomAttributes = "";
        $this->status_json->EditValue = $this->status_json->CurrentValue;
        $this->status_json->PlaceHolder = RemoveHtml($this->status_json->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->denied);
                    $doc->exportCaption($this->status);
                    $doc->exportCaption($this->status_matrix);
                    $doc->exportCaption($this->status_json);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->pending);
                    $doc->exportCaption($this->approved);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->denied);
                        $doc->exportField($this->status);
                        $doc->exportField($this->status_matrix);
                        $doc->exportField($this->status_json);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->pending);
                        $doc->exportField($this->approved);
