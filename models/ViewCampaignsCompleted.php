...
/**
 * Table class for view_campaigns_completed
 */
class ViewCampaignsCompleted extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_campaigns_completed';
        $this->TableName = 'view_campaigns_completed';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_campaigns_completed\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // payment_date
        $this->payment_date = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_payment_date', 'payment_date', '"payment_date"', CastDateFieldForLike("\"payment_date\"", 0, "DB"), 133, 4, 0, false, '"payment_date"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // start_date
        $this->start_date = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_start_date', 'start_date', '"start_date"', CastDateFieldForLike("\"start_date\"", 0, "DB"), 133, 4, 0, false, '"start_date"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // end_date
        $this->end_date = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_end_date', 'end_date', '"end_date"', CastDateFieldForLike("\"end_date\"", 0, "DB"), 133, 4, 0, false, '"end_date"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // inventory
        $this->inventory = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_inventory', 'inventory', '"inventory"', '"inventory"', 201, 0, -1, false, '"inventory"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->inventory->Sortable = true; // Allow sort
        $this->Fields['inventory'] = &$this->inventory;

        // platform
        $this->platform = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_platform', 'platform', '"platform"', '"platform"', 200, 50, -1, false, '"platform"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->platform->Sortable = true; // Allow sort
        $this->Fields['platform'] = &$this->platform;

        // operator
        $this->operator = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_operator', 'operator', '"operator"', '"operator"', 200, 50, -1, false, '"operator"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->operator->Sortable = true; // Allow sort
        $this->Fields['operator'] = &$this->operator;

        // bus_size
        $this->bus_size = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_bus_size', 'bus_size', '"bus_size"', '"bus_size"', 201, 0, -1, false, '"bus_size"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->bus_size->Sortable = true; // Allow sort
        $this->Fields['bus_size'] = &$this->bus_size;

        // print_stage
        $this->print_stage = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_print_stage', 'print_stage', '"print_stage"', '"print_stage"', 201, 0, -1, false, '"print_stage"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->print_stage->Sortable = true; // Allow sort
        $this->Fields['print_stage'] = &$this->print_stage;

        // campaign
        $this->campaign = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_campaign', 'campaign', '"campaign"', '"campaign"', 201, 0, -1, false, '"campaign"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->campaign->Sortable = true; // Allow sort
        $this->Fields['campaign'] = &$this->campaign;

        // vendor
        $this->vendor = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_vendor', 'vendor', '"vendor"', '"vendor"', 200, 0, -1, false, '"vendor"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->vendor->Sortable = true; // Allow sort
        $this->Fields['vendor'] = &$this->vendor;

        // quantity
        $this->quantity = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_quantity', 'quantity', '"quantity"', 'CAST("quantity" AS varchar(255))', 3, 4, -1, false, '"quantity"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->quantity->Sortable = true; // Allow sort
        $this->quantity->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['quantity'] = &$this->quantity;

        // price
        $this->price = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_price', 'price', '"price"', 'CAST("price" AS varchar(255))', 20, 8, -1, false, '"price"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->price->Sortable = true; // Allow sort
        $this->price->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['price'] = &$this->price;

        // operator_fee
        $this->operator_fee = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_operator_fee', 'operator_fee', '"operator_fee"', 'CAST("operator_fee" AS varchar(255))', 20, 8, -1, false, '"operator_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // lamata_fee
        $this->lamata_fee = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_lamata_fee', 'lamata_fee', '"lamata_fee"', 'CAST("lamata_fee" AS varchar(255))', 20, 8, -1, false, '"lamata_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // agency_fee
        $this->agency_fee = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_agency_fee', 'agency_fee', '"agency_fee"', 'CAST("agency_fee" AS varchar(255))', 20, 8, -1, false, '"agency_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // lasaa_fee
        $this->lasaa_fee = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_lasaa_fee', 'lasaa_fee', '"lasaa_fee"', 'CAST("lasaa_fee" AS varchar(255))', 20, 8, -1, false, '"lasaa_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // printers_fee
        $this->printers_fee = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_printers_fee', 'printers_fee', '"printers_fee"', 'CAST("printers_fee" AS varchar(255))', 20, 8, -1, false, '"printers_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // transaction_status
        $this->transaction_status = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_transaction_status', 'transaction_status', '"transaction_status"', '"transaction_status"', 200, 0, -1, false, '"transaction_status"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->transaction_status->Sortable = true; // Allow sort
        $this->Fields['transaction_status'] = &$this->transaction_status;

        // payment_status
        $this->payment_status = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_payment_status', 'payment_status', '"payment_status"', '"payment_status"', 200, 0, -1, false, '"payment_status"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->payment_status->Sortable = true; // Allow sort
        $this->Fields['payment_status'] = &$this->payment_status;

        // transaction_id
        $this->transaction_id = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_transaction_id', 'transaction_id', '"transaction_id"', 'CAST("transaction_id" AS varchar(255))', 3, 4, -1, false, '"transaction_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // payment_status_id
        $this->payment_status_id = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_payment_status_id', 'payment_status_id', '"payment_status_id"', 'CAST("payment_status_id" AS varchar(255))', 3, 4, -1, false, '"payment_status_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_id
        $this->status_id = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_status_id', 'status_id', '"status_id"', 'CAST("status_id" AS varchar(255))', 3, 4, -1, false, '"status_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // vendor_id
        $this->vendor_id = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_vendor_id', 'vendor_id', '"vendor_id"', 'CAST("vendor_id" AS varchar(255))', 3, 4, -1, false, '"vendor_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // inventory_id
        $this->inventory_id = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_inventory_id', 'inventory_id', '"inventory_id"', 'CAST("inventory_id" AS varchar(255))', 3, 4, -1, false, '"inventory_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // platform_id
        $this->platform_id = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_platform_id', 'platform_id', '"platform_id"', 'CAST("platform_id" AS varchar(255))', 3, 4, -1, false, '"platform_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // operator_id
        $this->operator_id = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_operator_id', 'operator_id', '"operator_id"', 'CAST("operator_id" AS varchar(255))', 3, 4, -1, false, '"operator_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bus_size_id
        $this->bus_size_id = new DbField('view_campaigns_completed', 'view_campaigns_completed', 'x_bus_size_id', 'bus_size_id', '"bus_size_id"', 'CAST("bus_size_id" AS varchar(255))', 3, 4, -1, false, '"bus_size_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($detailUrl == "") {
            $detailUrl = "viewcampaignscompletedlist";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_campaigns_completed\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("viewcampaignscompletedlist");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "viewcampaignscompletedview") {
            return $Language->phrase("View");
        } elseif ($pageName == "viewcampaignscompletededit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "viewcampaignscompletedadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewCampaignsCompletedView";
            case Config("API_ADD_ACTION"):
                return "ViewCampaignsCompletedAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewCampaignsCompletedEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewCampaignsCompletedDelete";
            case Config("API_LIST_ACTION"):
                return "ViewCampaignsCompletedList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("viewcampaignscompletedview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("viewcampaignscompletedview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "viewcampaignscompletedadd?" . $this->getUrlParm($parm);
        } else {
            $url = "viewcampaignscompletedadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewcampaignscompletededit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewcampaignscompletedadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("viewcampaignscompleteddelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        if (!$this->isExport()) {
            ...
            $this->inventory->LinkAttrs["data-tooltip-id"] = "tt_view_campaigns_completed_x" . (($this->RowType != ROWTYPE_MASTER) ? @$this->RowCount : "") . "_inventory";
    ...
    public function rowRendered()
    {
        ...
        //var_dump($this-><FieldName>);
            ...
            if($this->status_id->DbValue == 1 || $this->status_id->DbValue == 4){
                // PENDING
                $final_attr = "class='btn btn-block btn-info'";
            }elseif($this->status_id->DbValue == 3){
                // DENIED
                $final_attr = "class='btn btn-block btn-danger'";
            }elseif($this->status_id->DbValue == 2){
                // APPROVED
                $final_attr = "class='btn btn-block btn-success'";
            }elseif($this->status_id->DbValue == 5){
                // APPROVED EXPIRED
                $final_attr = "class='btn btn-block disabled btn-success'";
            }
            $this->transaction_status->LinkCustomAttributes = $final_attr;
            $this->transaction_status->HrefValue = $href_val;
    }
