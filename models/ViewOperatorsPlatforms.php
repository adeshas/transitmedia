...
/**
 * Table class for view_operators_platforms
 */
class ViewOperatorsPlatforms extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_operators_platforms';
        $this->TableName = 'view_operators_platforms';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_operators_platforms\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_operators_platforms\"";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->campaign_platform_id->DbValue = $row['campaign_platform_id'];
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("viewoperatorsplatformslist");
        }
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewOperatorsPlatformsView";
            case Config("API_ADD_ACTION"):
                return "ViewOperatorsPlatformsAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewOperatorsPlatformsEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewOperatorsPlatformsDelete";
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        // campaign_platform_id
        $this->campaign_platform_id->EditAttrs["class"] = "form-control";
        $this->campaign_platform_id->EditCustomAttributes = "";
        $this->campaign_platform_id->EditValue = $this->campaign_platform_id->CurrentValue;
        $this->campaign_platform_id->PlaceHolder = RemoveHtml($this->campaign_platform_id->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->campaign_platform_id);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->campaign_platform_id);
