...
/**
 * Table class for view_payments_tracker
 */
class ViewPaymentsTracker extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_payments_tracker';
        $this->TableName = 'view_payments_tracker';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_payments_tracker\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // transaction_id
        $this->transaction_id = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_transaction_id', 'transaction_id', '"transaction_id"', 'CAST("transaction_id" AS varchar(255))', 3, 4, -1, false, '"transaction_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // campaign_id
        $this->campaign_id = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_campaign_id', 'campaign_id', '"campaign_id"', 'CAST("campaign_id" AS varchar(255))', 3, 4, -1, false, '"campaign_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // campaign_name
        $this->campaign_name = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_campaign_name', 'campaign_name', '"campaign_name"', '"campaign_name"', 201, 0, -1, false, '"campaign_name"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->campaign_name->Sortable = true; // Allow sort
        $this->Fields['campaign_name'] = &$this->campaign_name;

        // quantity
        $this->quantity = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_quantity', 'quantity', '"quantity"', 'CAST("quantity" AS varchar(255))', 3, 4, -1, false, '"quantity"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->quantity->Sortable = true; // Allow sort
        $this->quantity->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['quantity'] = &$this->quantity;

        // campaign_status
        $this->campaign_status = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_campaign_status', 'campaign_status', '"campaign_status"', '"campaign_status"', 200, 0, -1, false, '"campaign_status"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->campaign_status->Sortable = true; // Allow sort
        $this->Fields['campaign_status'] = &$this->campaign_status;

        // print_status
        $this->print_status = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_print_status', 'print_status', '"print_status"', '"print_status"', 200, 0, -1, false, '"print_status"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->print_status->Sortable = true; // Allow sort
        $this->Fields['print_status'] = &$this->print_status;

        // payment_status
        $this->payment_status = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_payment_status', 'payment_status', '"payment_status"', '"payment_status"', 200, 0, -1, false, '"payment_status"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->payment_status->Sortable = true; // Allow sort
        $this->Fields['payment_status'] = &$this->payment_status;

        // start_date
        $this->start_date = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_start_date', 'start_date', '"start_date"', CastDateFieldForLike("\"start_date\"", 0, "DB"), 133, 4, 0, false, '"start_date"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // end_date
        $this->end_date = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_end_date', 'end_date', '"end_date"', CastDateFieldForLike("\"end_date\"", 0, "DB"), 133, 4, 0, false, '"end_date"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // vendor
        $this->vendor = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_vendor', 'vendor', '"vendor"', '"vendor"', 200, 0, -1, false, '"vendor"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->vendor->Sortable = true; // Allow sort
        $this->Fields['vendor'] = &$this->vendor;

        // operator
        $this->operator = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_operator', 'operator', '"operator"', '"operator"', 200, 50, -1, false, '"operator"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->operator->Sortable = true; // Allow sort
        $this->Fields['operator'] = &$this->operator;

        // platform
        $this->platform = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_platform', 'platform', '"platform"', '"platform"', 200, 50, -1, false, '"platform"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->platform->Sortable = true; // Allow sort
        $this->Fields['platform'] = &$this->platform;

        // inventory
        $this->inventory = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_inventory', 'inventory', '"inventory"', '"inventory"', 201, 0, -1, false, '"inventory"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->inventory->Sortable = true; // Allow sort
        $this->Fields['inventory'] = &$this->inventory;

        // bus_size
        $this->bus_size = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_bus_size', 'bus_size', '"bus_size"', '"bus_size"', 201, 0, -1, false, '"bus_size"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->bus_size->Sortable = true; // Allow sort
        $this->Fields['bus_size'] = &$this->bus_size;

        // print_stage
        $this->print_stage = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_print_stage', 'print_stage', '"print_stage"', '"print_stage"', 201, 0, -1, false, '"print_stage"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->print_stage->Sortable = true; // Allow sort
        $this->Fields['print_stage'] = &$this->print_stage;

        // price
        $this->price = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_price', 'price', '"price"', 'CAST("price" AS varchar(255))', 20, 8, -1, false, '"price"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->price->Sortable = true; // Allow sort
        $this->price->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['price'] = &$this->price;

        // operator_fee
        $this->operator_fee = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_operator_fee', 'operator_fee', '"operator_fee"', 'CAST("operator_fee" AS varchar(255))', 20, 8, -1, false, '"operator_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // agency_fee
        $this->agency_fee = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_agency_fee', 'agency_fee', '"agency_fee"', 'CAST("agency_fee" AS varchar(255))', 20, 8, -1, false, '"agency_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // lamata_fee
        $this->lamata_fee = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_lamata_fee', 'lamata_fee', '"lamata_fee"', 'CAST("lamata_fee" AS varchar(255))', 20, 8, -1, false, '"lamata_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // lasaa_fee
        $this->lasaa_fee = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_lasaa_fee', 'lasaa_fee', '"lasaa_fee"', 'CAST("lasaa_fee" AS varchar(255))', 20, 8, -1, false, '"lasaa_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // printers_fee
        $this->printers_fee = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_printers_fee', 'printers_fee', '"printers_fee"', 'CAST("printers_fee" AS varchar(255))', 20, 8, -1, false, '"printers_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // price_details
        $this->price_details = new DbField('view_payments_tracker', 'view_payments_tracker', 'x_price_details', 'price_details', '"price_details"', '"price_details"', 201, 0, -1, false, '"price_details"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_payments_tracker\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("viewpaymentstrackerlist");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "viewpaymentstrackerview") {
            return $Language->phrase("View");
        } elseif ($pageName == "viewpaymentstrackeredit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "viewpaymentstrackeradd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPaymentsTrackerView";
            case Config("API_ADD_ACTION"):
                return "ViewPaymentsTrackerAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPaymentsTrackerEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPaymentsTrackerDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPaymentsTrackerList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("viewpaymentstrackerview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("viewpaymentstrackerview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "viewpaymentstrackeradd?" . $this->getUrlParm($parm);
        } else {
            $url = "viewpaymentstrackeradd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewpaymentstrackeredit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewpaymentstrackeradd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("viewpaymentstrackerdelete", $this->getUrlParm());
    }
