...
/**
 * Table class for view_pricing_all
 */
class ViewPricingAll extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_pricing_all';
        $this->TableName = 'view_pricing_all';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_pricing_all\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_pricing_all', 'view_pricing_all', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->id->Sortable = true; // Allow sort
        $this->id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['id'] = &$this->id;

        // platform_id
        $this->platform_id = new DbField('view_pricing_all', 'view_pricing_all', 'x_platform_id', 'platform_id', '"platform_id"', 'CAST("platform_id" AS varchar(255))', 3, 4, -1, false, '"platform_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // platform
        $this->platform = new DbField('view_pricing_all', 'view_pricing_all', 'x_platform', 'platform', '"platform"', '"platform"', 200, 50, -1, false, '"platform"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->platform->Sortable = true; // Allow sort
        $this->Fields['platform'] = &$this->platform;

        // inventory_id
        $this->inventory_id = new DbField('view_pricing_all', 'view_pricing_all', 'x_inventory_id', 'inventory_id', '"inventory_id"', 'CAST("inventory_id" AS varchar(255))', 3, 4, -1, false, '"inventory_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // inventory
        $this->inventory = new DbField('view_pricing_all', 'view_pricing_all', 'x_inventory', 'inventory', '"inventory"', '"inventory"', 201, 0, -1, false, '"inventory"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->inventory->Sortable = true; // Allow sort
        $this->Fields['inventory'] = &$this->inventory;

        // print_stage_id
        $this->print_stage_id = new DbField('view_pricing_all', 'view_pricing_all', 'x_print_stage_id', 'print_stage_id', '"print_stage_id"', 'CAST("print_stage_id" AS varchar(255))', 3, 4, -1, false, '"print_stage_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // print_stage
        $this->print_stage = new DbField('view_pricing_all', 'view_pricing_all', 'x_print_stage', 'print_stage', '"print_stage"', '"print_stage"', 201, 0, -1, false, '"print_stage"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->print_stage->Sortable = true; // Allow sort
        $this->Fields['print_stage'] = &$this->print_stage;

        // bus_size_id
        $this->bus_size_id = new DbField('view_pricing_all', 'view_pricing_all', 'x_bus_size_id', 'bus_size_id', '"bus_size_id"', 'CAST("bus_size_id" AS varchar(255))', 3, 4, -1, false, '"bus_size_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bus_size
        $this->bus_size = new DbField('view_pricing_all', 'view_pricing_all', 'x_bus_size', 'bus_size', '"bus_size"', '"bus_size"', 201, 0, -1, false, '"bus_size"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->bus_size->Sortable = true; // Allow sort
        $this->Fields['bus_size'] = &$this->bus_size;

        // details
        $this->details = new DbField('view_pricing_all', 'view_pricing_all', 'x_details', 'details', '"details"', '"details"', 201, 0, -1, false, '"details"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->details->Sortable = true; // Allow sort
        $this->Fields['details'] = &$this->details;

        // max_limit
        $this->max_limit = new DbField('view_pricing_all', 'view_pricing_all', 'x_max_limit', 'max_limit', '"max_limit"', 'CAST("max_limit" AS varchar(255))', 3, 4, -1, false, '"max_limit"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // min_limit
        $this->min_limit = new DbField('view_pricing_all', 'view_pricing_all', 'x_min_limit', 'min_limit', '"min_limit"', 'CAST("min_limit" AS varchar(255))', 3, 4, -1, false, '"min_limit"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // price
        $this->price = new DbField('view_pricing_all', 'view_pricing_all', 'x_price', 'price', '"price"', 'CAST("price" AS varchar(255))', 20, 8, -1, false, '"price"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->price->Sortable = true; // Allow sort
        $this->price->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['price'] = &$this->price;

        // operator_fee
        $this->operator_fee = new DbField('view_pricing_all', 'view_pricing_all', 'x_operator_fee', 'operator_fee', '"operator_fee"', 'CAST("operator_fee" AS varchar(255))', 20, 8, -1, false, '"operator_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // agency_fee
        $this->agency_fee = new DbField('view_pricing_all', 'view_pricing_all', 'x_agency_fee', 'agency_fee', '"agency_fee"', 'CAST("agency_fee" AS varchar(255))', 20, 8, -1, false, '"agency_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // lamata_fee
        $this->lamata_fee = new DbField('view_pricing_all', 'view_pricing_all', 'x_lamata_fee', 'lamata_fee', '"lamata_fee"', 'CAST("lamata_fee" AS varchar(255))', 20, 8, -1, false, '"lamata_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // lasaa_fee
        $this->lasaa_fee = new DbField('view_pricing_all', 'view_pricing_all', 'x_lasaa_fee', 'lasaa_fee', '"lasaa_fee"', 'CAST("lasaa_fee" AS varchar(255))', 20, 8, -1, false, '"lasaa_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // printers_fee
        $this->printers_fee = new DbField('view_pricing_all', 'view_pricing_all', 'x_printers_fee', 'printers_fee', '"printers_fee"', 'CAST("printers_fee" AS varchar(255))', 20, 8, -1, false, '"printers_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // active
        $this->active = new DbField('view_pricing_all', 'view_pricing_all', 'x_active', 'active', '"active"', 'CAST("active" AS varchar(255))', 11, 1, -1, false, '"active"', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->active->Sortable = true; // Allow sort
        $this->active->DataType = DATATYPE_BOOLEAN;
        $this->active->Lookup = new Lookup('active', 'view_pricing_all', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_pricing_all\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("viewpricingalllist");
    }
    ...
    {
        global $Language;
        if ($pageName == "viewpricingallview") {
            return $Language->phrase("View");
        } elseif ($pageName == "viewpricingalledit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "viewpricingalladd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPricingAllView";
            case Config("API_ADD_ACTION"):
                return "ViewPricingAllAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPricingAllEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPricingAllDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPricingAllList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("viewpricingallview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("viewpricingallview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "viewpricingalladd?" . $this->getUrlParm($parm);
        } else {
            $url = "viewpricingalladd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewpricingalledit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("viewpricingalladd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("viewpricingalldelete", $this->getUrlParm());
    }
