...
/**
 * Table class for view_pricing_options
 */
class ViewPricingOptions extends DbTable
{
    protected $SqlFrom = "";
    ...
    // Fields
    public $platform_inventory;
    public $price_details;
    public $price_id;
    public $requested_price_id;
    public $campaign_id;
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_pricing_options';
        $this->TableName = 'view_pricing_options';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_pricing_options\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_pricing_options\"";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->platform_inventory->DbValue = $row['platform_inventory'];
        $this->price_details->DbValue = $row['price_details'];
        $this->price_id->DbValue = $row['price_id'];
        $this->requested_price_id->DbValue = $row['requested_price_id'];
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPricingOptionsView";
            case Config("API_ADD_ACTION"):
                return "ViewPricingOptionsAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPricingOptionsEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPricingOptionsDelete";
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // platform_inventory
        $this->platform_inventory->ViewValue = $this->platform_inventory->CurrentValue;
        $this->platform_inventory->ViewCustomAttributes = "";
        ...
        // platform_inventory
        $this->platform_inventory->LinkCustomAttributes = "";
        $this->platform_inventory->HrefValue = "";
        $this->platform_inventory->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // platform_inventory
        $this->platform_inventory->EditAttrs["class"] = "form-control";
        $this->platform_inventory->EditCustomAttributes = "";
        $this->platform_inventory->EditValue = $this->platform_inventory->CurrentValue;
        $this->platform_inventory->PlaceHolder = RemoveHtml($this->platform_inventory->caption());
        ...
        $this->price_id->EditValue = $this->price_id->CurrentValue;
        $this->price_id->PlaceHolder = RemoveHtml($this->price_id->caption());

        // requested_price_id
        $this->requested_price_id->EditAttrs["class"] = "form-control";
        $this->requested_price_id->EditCustomAttributes = "";
        $this->requested_price_id->EditValue = $this->requested_price_id->CurrentValue;
        $this->requested_price_id->PlaceHolder = RemoveHtml($this->requested_price_id->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->platform_inventory);
                    $doc->exportCaption($this->price_details);
                    $doc->exportCaption($this->price_id);
                    $doc->exportCaption($this->requested_price_id);
        ...
        while (!$recordset->EOF && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->platform_inventory);
                        $doc->exportField($this->price_details);
                        $doc->exportField($this->price_id);
                        $doc->exportField($this->requested_price_id);
