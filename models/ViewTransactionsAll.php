...
/**
 * Table class for view_transactions_all
 */
class ViewTransactionsAll extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_transactions_all';
        $this->TableName = 'view_transactions_all';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_transactions_all\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // payment_date
        $this->payment_date = new DbField('view_transactions_all', 'view_transactions_all', 'x_payment_date', 'payment_date', '"payment_date"', CastDateFieldForLike("\"payment_date\"", 0, "DB"), 133, 4, 0, false, '"payment_date"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // start_date
        $this->start_date = new DbField('view_transactions_all', 'view_transactions_all', 'x_start_date', 'start_date', '"start_date"', CastDateFieldForLike("\"start_date\"", 0, "DB"), 133, 4, 0, false, '"start_date"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // end_date
        $this->end_date = new DbField('view_transactions_all', 'view_transactions_all', 'x_end_date', 'end_date', '"end_date"', CastDateFieldForLike("\"end_date\"", 0, "DB"), 133, 4, 0, false, '"end_date"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // inventory
        $this->inventory = new DbField('view_transactions_all', 'view_transactions_all', 'x_inventory', 'inventory', '"inventory"', '"inventory"', 201, 0, -1, false, '"inventory"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->inventory->Sortable = true; // Allow sort
        $this->Fields['inventory'] = &$this->inventory;

        // platform
        $this->platform = new DbField('view_transactions_all', 'view_transactions_all', 'x_platform', 'platform', '"platform"', '"platform"', 200, 50, -1, false, '"platform"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->platform->Sortable = true; // Allow sort
        $this->Fields['platform'] = &$this->platform;

        // operator
        $this->operator = new DbField('view_transactions_all', 'view_transactions_all', 'x_operator', 'operator', '"operator"', '"operator"', 200, 50, -1, false, '"operator"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->operator->Sortable = true; // Allow sort
        $this->Fields['operator'] = &$this->operator;

        // bus_size
        $this->bus_size = new DbField('view_transactions_all', 'view_transactions_all', 'x_bus_size', 'bus_size', '"bus_size"', '"bus_size"', 201, 0, -1, false, '"bus_size"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->bus_size->Sortable = true; // Allow sort
        $this->Fields['bus_size'] = &$this->bus_size;

        // print_stage
        $this->print_stage = new DbField('view_transactions_all', 'view_transactions_all', 'x_print_stage', 'print_stage', '"print_stage"', '"print_stage"', 201, 0, -1, false, '"print_stage"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->print_stage->Sortable = true; // Allow sort
        $this->Fields['print_stage'] = &$this->print_stage;

        // campaign
        $this->campaign = new DbField('view_transactions_all', 'view_transactions_all', 'x_campaign', 'campaign', '"campaign"', '"campaign"', 201, 0, -1, false, '"campaign"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->campaign->Sortable = true; // Allow sort
        $this->Fields['campaign'] = &$this->campaign;

        // vendor
        $this->vendor = new DbField('view_transactions_all', 'view_transactions_all', 'x_vendor', 'vendor', '"vendor"', '"vendor"', 200, 0, -1, false, '"vendor"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->vendor->Sortable = true; // Allow sort
        $this->Fields['vendor'] = &$this->vendor;

        // quantity
        $this->quantity = new DbField('view_transactions_all', 'view_transactions_all', 'x_quantity', 'quantity', '"quantity"', 'CAST("quantity" AS varchar(255))', 3, 4, -1, false, '"quantity"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->quantity->Sortable = true; // Allow sort
        $this->quantity->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['quantity'] = &$this->quantity;

        // price
        $this->price = new DbField('view_transactions_all', 'view_transactions_all', 'x_price', 'price', '"price"', 'CAST("price" AS varchar(255))', 20, 8, -1, false, '"price"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->price->Sortable = true; // Allow sort
        $this->price->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['price'] = &$this->price;

        // operator_fee
        $this->operator_fee = new DbField('view_transactions_all', 'view_transactions_all', 'x_operator_fee', 'operator_fee', '"operator_fee"', 'CAST("operator_fee" AS varchar(255))', 20, 8, -1, false, '"operator_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // lamata_fee
        $this->lamata_fee = new DbField('view_transactions_all', 'view_transactions_all', 'x_lamata_fee', 'lamata_fee', '"lamata_fee"', 'CAST("lamata_fee" AS varchar(255))', 20, 8, -1, false, '"lamata_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // agency_fee
        $this->agency_fee = new DbField('view_transactions_all', 'view_transactions_all', 'x_agency_fee', 'agency_fee', '"agency_fee"', 'CAST("agency_fee" AS varchar(255))', 20, 8, -1, false, '"agency_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // lasaa_fee
        $this->lasaa_fee = new DbField('view_transactions_all', 'view_transactions_all', 'x_lasaa_fee', 'lasaa_fee', '"lasaa_fee"', 'CAST("lasaa_fee" AS varchar(255))', 20, 8, -1, false, '"lasaa_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // printers_fee
        $this->printers_fee = new DbField('view_transactions_all', 'view_transactions_all', 'x_printers_fee', 'printers_fee', '"printers_fee"', 'CAST("printers_fee" AS varchar(255))', 20, 8, -1, false, '"printers_fee"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // transaction_status
        $this->transaction_status = new DbField('view_transactions_all', 'view_transactions_all', 'x_transaction_status', 'transaction_status', '"transaction_status"', '"transaction_status"', 200, 0, -1, false, '"transaction_status"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->transaction_status->Sortable = true; // Allow sort
        $this->Fields['transaction_status'] = &$this->transaction_status;

        // transaction_id
        $this->transaction_id = new DbField('view_transactions_all', 'view_transactions_all', 'x_transaction_id', 'transaction_id', '"transaction_id"', 'CAST("transaction_id" AS varchar(255))', 3, 4, -1, false, '"transaction_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_id
        $this->status_id = new DbField('view_transactions_all', 'view_transactions_all', 'x_status_id', 'status_id', '"status_id"', 'CAST("status_id" AS varchar(255))', 3, 4, -1, false, '"status_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // vendor_id
        $this->vendor_id = new DbField('view_transactions_all', 'view_transactions_all', 'x_vendor_id', 'vendor_id', '"vendor_id"', 'CAST("vendor_id" AS varchar(255))', 3, 4, -1, false, '"vendor_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // inventory_id
        $this->inventory_id = new DbField('view_transactions_all', 'view_transactions_all', 'x_inventory_id', 'inventory_id', '"inventory_id"', 'CAST("inventory_id" AS varchar(255))', 3, 4, -1, false, '"inventory_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // platform_id
        $this->platform_id = new DbField('view_transactions_all', 'view_transactions_all', 'x_platform_id', 'platform_id', '"platform_id"', 'CAST("platform_id" AS varchar(255))', 3, 4, -1, false, '"platform_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // operator_id
        $this->operator_id = new DbField('view_transactions_all', 'view_transactions_all', 'x_operator_id', 'operator_id', '"operator_id"', 'CAST("operator_id" AS varchar(255))', 3, 4, -1, false, '"operator_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bus_size_id
        $this->bus_size_id = new DbField('view_transactions_all', 'view_transactions_all', 'x_bus_size_id', 'bus_size_id', '"bus_size_id"', 'CAST("bus_size_id" AS varchar(255))', 3, 4, -1, false, '"bus_size_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_transactions_all\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("viewtransactionsalllist");
        }
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewTransactionsAllView";
            case Config("API_ADD_ACTION"):
                return "ViewTransactionsAllAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewTransactionsAllEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewTransactionsAllDelete";
