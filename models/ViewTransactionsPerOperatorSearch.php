 ...
 * Page class
 */
class ViewTransactionsPerOperatorSearch extends ViewTransactionsPerOperator
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewTransactionsPerOperatorSearch";
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!$this->isExport()) {
                ...
                $this->inventory->LinkAttrs["data-tooltip-id"] = "tt_view_transactions_per_operator_x_inventory";
