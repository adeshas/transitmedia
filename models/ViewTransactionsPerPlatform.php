...
/**
 * Table class for view_transactions_per_platform
 */
class ViewTransactionsPerPlatform extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_transactions_per_platform';
        $this->TableName = 'view_transactions_per_platform';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "\"view_transactions_per_platform\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // transaction_id
        $this->transaction_id = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_transaction_id', 'transaction_id', '"transaction_id"', 'CAST("transaction_id" AS varchar(255))', 3, 4, -1, false, '"transaction_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // campaign
        $this->campaign = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_campaign', 'campaign', '"campaign"', '"campaign"', 201, 0, -1, false, '"campaign"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->campaign->Sortable = true; // Allow sort
        $this->Fields['campaign'] = &$this->campaign;

        // payment_date
        $this->payment_date = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_payment_date', 'payment_date', '"payment_date"', CastDateFieldForLike("\"payment_date\"", 0, "DB"), 133, 4, 0, false, '"payment_date"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // inventory
        $this->inventory = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_inventory', 'inventory', '"inventory"', '"inventory"', 201, 0, -1, false, '"inventory"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->inventory->Sortable = true; // Allow sort
        $this->Fields['inventory'] = &$this->inventory;

        // bus_size
        $this->bus_size = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_bus_size', 'bus_size', '"bus_size"', '"bus_size"', 201, 0, -1, false, '"bus_size"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->bus_size->Sortable = true; // Allow sort
        $this->Fields['bus_size'] = &$this->bus_size;

        // print_stage
        $this->print_stage = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_print_stage', 'print_stage', '"print_stage"', '"print_stage"', 201, 0, -1, false, '"print_stage"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->print_stage->Sortable = true; // Allow sort
        $this->Fields['print_stage'] = &$this->print_stage;

        // vendor
        $this->vendor = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_vendor', 'vendor', '"vendor"', '"vendor"', 200, 0, -1, false, '"vendor"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->vendor->Sortable = true; // Allow sort
        $this->Fields['vendor'] = &$this->vendor;

        // operator
        $this->operator = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_operator', 'operator', '"operator"', '"operator"', 200, 50, -1, false, '"operator"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // end_date
        $this->end_date = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_end_date', 'end_date', '"end_date"', CastDateFieldForLike("\"end_date\"", 0, "DB"), 133, 4, 0, false, '"end_date"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // platform
        $this->platform = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_platform', 'platform', '"platform"', '"platform"', 200, 50, -1, false, '"platform"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->platform->Sortable = true; // Allow sort
        $this->Fields['platform'] = &$this->platform;

        // status_id
        $this->status_id = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_status_id', 'status_id', '"status_id"', 'CAST("status_id" AS varchar(255))', 3, 4, -1, false, '"status_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // vendor_id
        $this->vendor_id = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_vendor_id', 'vendor_id', '"vendor_id"', 'CAST("vendor_id" AS varchar(255))', 3, 4, -1, false, '"vendor_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->vendor_id->Sortable = false; // Allow sort
        $this->vendor_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['vendor_id'] = &$this->vendor_id;

        // inventory_id
        $this->inventory_id = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_inventory_id', 'inventory_id', '"inventory_id"', 'CAST("inventory_id" AS varchar(255))', 3, 4, -1, false, '"inventory_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // platform_id
        $this->platform_id = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_platform_id', 'platform_id', '"platform_id"', 'CAST("platform_id" AS varchar(255))', 3, 4, -1, false, '"platform_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->platform_id->Sortable = false; // Allow sort
        $this->platform_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['platform_id'] = &$this->platform_id;

        // operator_id
        $this->operator_id = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_operator_id', 'operator_id', '"operator_id"', 'CAST("operator_id" AS varchar(255))', 3, 4, -1, false, '"operator_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->operator_id->Sortable = false; // Allow sort
        $this->operator_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['operator_id'] = &$this->operator_id;

        // bus_size_id
        $this->bus_size_id = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_bus_size_id', 'bus_size_id', '"bus_size_id"', 'CAST("bus_size_id" AS varchar(255))', 3, 4, -1, false, '"bus_size_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->bus_size_id->Sortable = false; // Allow sort
        $this->bus_size_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['bus_size_id'] = &$this->bus_size_id;

        // vendor_search_id
        $this->vendor_search_id = new DbField('view_transactions_per_platform', 'view_transactions_per_platform', 'x_vendor_search_id', 'vendor_search_id', '"vendor_search_id"', 'CAST("vendor_search_id" AS varchar(255))', 3, 4, -1, false, '"vendor_search_id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->vendor_search_id->Sortable = false; // Allow sort
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"view_transactions_per_platform\"";
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "\"status_id\" in (2,5)";
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewTransactionsPerPlatformView";
            case Config("API_ADD_ACTION"):
                return "ViewTransactionsPerPlatformAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewTransactionsPerPlatformEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewTransactionsPerPlatformDelete";
