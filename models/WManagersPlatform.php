...
/**
 * Table class for w_managers_platform
 */
class WManagersPlatform extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'w_managers_platform';
        $this->TableName = 'w_managers_platform';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"w_managers_platform\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('w_managers_platform', 'w_managers_platform', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // platform_id
        $this->platform_id = new DbField('w_managers_platform', 'w_managers_platform', 'x_platform_id', 'platform_id', '"platform_id"', 'CAST("platform_id" AS varchar(255))', 3, 4, -1, false, '"platform_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // user_id
        $this->user_id = new DbField('w_managers_platform', 'w_managers_platform', 'x_user_id', 'user_id', '"user_id"', 'CAST("user_id" AS varchar(255))', 3, 4, -1, false, '"user_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"w_managers_platform\"";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->id->setDbValue($conn->fetchColumn("SELECT currval('w_managers_platform_id_seq'::regclass)"));
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("wmanagersplatformlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "wmanagersplatformview") {
            return $Language->phrase("View");
        } elseif ($pageName == "wmanagersplatformedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "wmanagersplatformadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "WManagersPlatformView";
            case Config("API_ADD_ACTION"):
                return "WManagersPlatformAdd";
            case Config("API_EDIT_ACTION"):
                return "WManagersPlatformEdit";
            case Config("API_DELETE_ACTION"):
                return "WManagersPlatformDelete";
            case Config("API_LIST_ACTION"):
                return "WManagersPlatformList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("wmanagersplatformview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("wmanagersplatformview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "wmanagersplatformadd?" . $this->getUrlParm($parm);
        } else {
            $url = "wmanagersplatformadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("wmanagersplatformedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("wmanagersplatformadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("wmanagersplatformdelete", $this->getUrlParm());
    }
