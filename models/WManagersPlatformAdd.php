 ...
 * Page class
 */
class WManagersPlatformAdd extends WManagersPlatform
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WManagersPlatformAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("wmanagersplatformlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "wmanagersplatformlist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "wmanagersplatformview") {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->user_id->ViewValue !== null) { // Load from cache
                ...
                foreach ($arwrk as &$row)
                    $row = $this->user_id->Lookup->renderViewRow($row);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("wmanagersplatformlist"), "", $this->TableVar, true);
