 ...
 * Page class
 */
class WManagersPlatformDelete extends WManagersPlatform
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WManagersPlatformDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("wmanagersplatformlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("wmanagersplatformlist"); // Return to list
                return;
            }
        }
