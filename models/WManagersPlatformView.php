 ...
 * Page class
 */
class WManagersPlatformView extends WManagersPlatform
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WManagersPlatformView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "wmanagersplatformlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "wmanagersplatformlist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "wmanagersplatformlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
