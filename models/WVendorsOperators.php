...
/**
 * Table class for w_vendors_operators
 */
class WVendorsOperators extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'w_vendors_operators';
        $this->TableName = 'w_vendors_operators';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"w_vendors_operators\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('w_vendors_operators', 'w_vendors_operators', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // vendor_id
        $this->vendor_id = new DbField('w_vendors_operators', 'w_vendors_operators', 'x_vendor_id', 'vendor_id', '"vendor_id"', 'CAST("vendor_id" AS varchar(255))', 3, 4, -1, false, '"vendor_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // operator_id
        $this->operator_id = new DbField('w_vendors_operators', 'w_vendors_operators', 'x_operator_id', 'operator_id', '"operator_id"', 'CAST("operator_id" AS varchar(255))', 3, 4, -1, false, '"operator_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"w_vendors_operators\"";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->id->setDbValue($conn->fetchColumn("SELECT currval('w_vendors_operators_id_seq'::regclass)"));
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("wvendorsoperatorslist");
        }
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "WVendorsOperatorsView";
            case Config("API_ADD_ACTION"):
                return "WVendorsOperatorsAdd";
            case Config("API_EDIT_ACTION"):
                return "WVendorsOperatorsEdit";
            case Config("API_DELETE_ACTION"):
                return "WVendorsOperatorsDelete";
