 ...
 * Page class
 */
class XBusSizesView extends XBusSizes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "XBusSizesView";
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("mainbuseslist?" . Config("TABLE_SHOW_MASTER") . "=x_bus_sizes&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("MainBusesGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'x_bus_sizes')) {
        ...
        if ($detailTblVar != "") {
            ...
            if (in_array("main_buses", $detailTblVar)) {
                ...
                if ($detailPageObj->DetailView) {
                    ...
                    $detailPageObj->bus_size_id->IsDetailKey = true;
                    $detailPageObj->bus_size_id->CurrentValue = $this->id->CurrentValue;
                    $detailPageObj->bus_size_id->setSessionValue($detailPageObj->bus_size_id->CurrentValue);
