 ...
 * Page class
 */
class XBusStatusView extends XBusStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "XBusStatusView";
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("mainbuseslist?" . Config("TABLE_SHOW_MASTER") . "=x_bus_status&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("MainBusesGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'x_bus_status')) {
        ...
        if ($detailTblVar != "") {
            ...
            if (in_array("main_buses", $detailTblVar)) {
                ...
                if ($detailPageObj->DetailView) {
                    ...
                    $detailPageObj->bus_status_id->IsDetailKey = true;
                    $detailPageObj->bus_status_id->CurrentValue = $this->id->CurrentValue;
                    $detailPageObj->bus_status_id->setSessionValue($detailPageObj->bus_status_id->CurrentValue);
                    $detailPageObj->bus_size_id->setSessionValue(""); // Clear session key
                    $detailPageObj->bus_depot_id->setSessionValue(""); // Clear session key
                }
            }
        }
    }
