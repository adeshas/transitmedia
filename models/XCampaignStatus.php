...
/**
 * Table class for x_campaign_status
 */
class XCampaignStatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'x_campaign_status';
        $this->TableName = 'x_campaign_status';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"x_campaign_status\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('x_campaign_status', 'x_campaign_status', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // name
        $this->name = new DbField('x_campaign_status', 'x_campaign_status', 'x_name', 'name', '"name"', '"name"', 200, 0, -1, false, '"name"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // admin_name
        $this->admin_name = new DbField('x_campaign_status', 'x_campaign_status', 'x_admin_name', 'admin_name', '"admin_name"', '"admin_name"', 200, 0, -1, false, '"admin_name"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->admin_name->Sortable = true; // Allow sort
        $this->Fields['admin_name'] = &$this->admin_name;

        // operator_name
        $this->operator_name = new DbField('x_campaign_status', 'x_campaign_status', 'x_operator_name', 'operator_name', '"operator_name"', '"operator_name"', 200, 0, -1, false, '"operator_name"', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"x_campaign_status\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("xcampaignstatuslist");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "xcampaignstatusview") {
            return $Language->phrase("View");
        } elseif ($pageName == "xcampaignstatusedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "xcampaignstatusadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "XCampaignStatusView";
            case Config("API_ADD_ACTION"):
                return "XCampaignStatusAdd";
            case Config("API_EDIT_ACTION"):
                return "XCampaignStatusEdit";
            case Config("API_DELETE_ACTION"):
                return "XCampaignStatusDelete";
            case Config("API_LIST_ACTION"):
                return "XCampaignStatusList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("xcampaignstatusview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("xcampaignstatusview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "xcampaignstatusadd?" . $this->getUrlParm($parm);
        } else {
            $url = "xcampaignstatusadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("xcampaignstatusedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("xcampaignstatusadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("xcampaignstatusdelete", $this->getUrlParm());
    }
