 ...
 * Page class
 */
class XCampaignStatusEdit extends XCampaignStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "XCampaignStatusEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("xcampaignstatuslist"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "xcampaignstatuslist") {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // admin_name
            $this->admin_name->setDbValueDef($rsnew, $this->admin_name->CurrentValue, null, $this->admin_name->ReadOnly);

            // operator_name
            $this->operator_name->setDbValueDef($rsnew, $this->operator_name->CurrentValue, null, $this->operator_name->ReadOnly);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("xcampaignstatuslist"), "", $this->TableVar, true);
        $pageId = "edit";
