...
/**
 * Table class for x_print_status
 */
class XPrintStatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'x_print_status';
        $this->TableName = 'x_print_status';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"x_print_status\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('x_print_status', 'x_print_status', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // name
        $this->name = new DbField('x_print_status', 'x_print_status', 'x_name', 'name', '"name"', '"name"', 200, 0, -1, false, '"name"', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"x_print_status\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("xprintstatuslist");
        }
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "XPrintStatusView";
            case Config("API_ADD_ACTION"):
                return "XPrintStatusAdd";
            case Config("API_EDIT_ACTION"):
                return "XPrintStatusEdit";
            case Config("API_DELETE_ACTION"):
                return "XPrintStatusDelete";
