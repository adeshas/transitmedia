...
/**
 * Table class for x_transaction_status
 */
class XTransactionStatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'x_transaction_status';
        $this->TableName = 'x_transaction_status';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"x_transaction_status\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->admin_name->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->admin_name->Param, "CustomMsg");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"x_transaction_status\"";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->id->setDbValue($conn->fetchColumn("SELECT currval('public.x_transaction_status_id_seq'::regclass)"));
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "XTransactionStatusView";
            case Config("API_ADD_ACTION"):
                return "XTransactionStatusAdd";
            case Config("API_EDIT_ACTION"):
                return "XTransactionStatusEdit";
            case Config("API_DELETE_ACTION"):
                return "XTransactionStatusDelete";
