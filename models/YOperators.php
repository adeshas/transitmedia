...
/**
 * Table class for y_operators
 */
class YOperators extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'y_operators';
        $this->TableName = 'y_operators';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"y_operators\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('y_operators', 'y_operators', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // platform_id
        $this->platform_id = new DbField('y_operators', 'y_operators', 'x_platform_id', 'platform_id', '"platform_id"', 'CAST("platform_id" AS varchar(255))', 3, 4, -1, false, '"platform_id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"y_operators\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("YOperatorsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "YOperatorsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "YOperatorsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "YOperatorsView";
            case Config("API_ADD_ACTION"):
                return "YOperatorsAdd";
            case Config("API_EDIT_ACTION"):
                return "YOperatorsEdit";
            case Config("API_DELETE_ACTION"):
                return "YOperatorsDelete";
            case Config("API_LIST_ACTION"):
                return "YOperatorsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("YOperatorsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("YOperatorsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "YOperatorsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "YOperatorsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("YOperatorsEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("YOperatorsEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("YOperatorsAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("YOperatorsAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("YOperatorsDelete", $this->getUrlParm());
    }
