 ...
 * Page class
 */
class YOperatorsUpdate extends YOperators
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "YOperatorsUpdate";
        ...
        if ($rs = $this->loadRecordset()) {
            ...
            while (!$rs->EOF) {
                if ($i == 1) {
                    ...
                    if (!CompareValue($this->shortname->DbValue, $rs->fields['shortname'])) {
    ...
    protected function loadFormValues()
    {
        ...
        $this->shortname->MultiUpdate = $CurrentForm->getValue("u_shortname");
    ...
    protected function validateForm()
    {
        ...
        if ($this->shortname->multiUpdateSelected()) {
            $updateCnt++;
        }
        ...
        if ($this->shortname->Required) {
            if ($this->shortname->MultiUpdate != "" && !$this->shortname->IsDetailKey && EmptyValue($this->shortname->FormValue)) {
