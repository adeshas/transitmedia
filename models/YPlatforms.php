...
/**
 * Table class for y_platforms
 */
class YPlatforms extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'y_platforms';
        $this->TableName = 'y_platforms';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"y_platforms\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('y_platforms', 'y_platforms', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "y_operators") {
            $detailUrl = Container("y_operators")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"y_platforms\"";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->id->setDbValue($conn->fetchColumn("SELECT currval('platforms_id_seq'::regclass)"));
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "YPlatformsView";
            case Config("API_ADD_ACTION"):
                return "YPlatformsAdd";
            case Config("API_EDIT_ACTION"):
                return "YPlatformsEdit";
            case Config("API_DELETE_ACTION"):
                return "YPlatformsDelete";
