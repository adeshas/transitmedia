...
/**
 * Table class for y_printers
 */
class YPrinters extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'y_printers';
        $this->TableName = 'y_printers';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"y_printers\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('y_printers', 'y_printers', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // name
        $this->name = new DbField('y_printers', 'y_printers', 'x_name', 'name', '"name"', '"name"', 201, 0, -1, false, '"name"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->name->Sortable = true; // Allow sort
        $this->name->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->name->Param, "CustomMsg");
        $this->Fields['name'] = &$this->name;

        // passcode
        $this->passcode = new DbField('y_printers', 'y_printers', 'x_passcode', 'passcode', '"passcode"', '"passcode"', 200, 5, -1, false, '"passcode"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->passcode->Sortable = true; // Allow sort
        $this->passcode->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->passcode->Param, "CustomMsg");
        $this->Fields['passcode'] = &$this->passcode;

        // email
        $this->_email = new DbField('y_printers', 'y_printers', 'x__email', 'email', '"email"', '"email"', 201, 0, -1, false, '"email"', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"y_printers\"";
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "YPrintersView";
            case Config("API_ADD_ACTION"):
                return "YPrintersAdd";
            case Config("API_EDIT_ACTION"):
                return "YPrintersEdit";
            case Config("API_DELETE_ACTION"):
                return "YPrintersDelete";
