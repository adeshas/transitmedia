...
/**
 * Table class for y_vendors
 */
class YVendors extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'y_vendors';
        $this->TableName = 'y_vendors';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"y_vendors\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('y_vendors', 'y_vendors', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // name
        $this->name = new DbField('y_vendors', 'y_vendors', 'x_name', 'name', '"name"', '"name"', 200, 0, -1, false, '"name"', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "main_users") {
            $detailUrl = Container("main_users")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"y_vendors\"";
    }
...
SORTHTML;
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM \"y_vendors\"";
