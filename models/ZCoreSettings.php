...
class ZCoreSettings extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('z_core_settings', 'z_core_settings', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // value
        $this->value = new DbField('z_core_settings', 'z_core_settings', 'x_value', 'value', '"value"', '"value"', 200, 0, -1, false, '"value"', false, false, false, 'FORMATTED TEXT', 'TEXT');
