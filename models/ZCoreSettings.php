...
/**
 * Table class for z_core_settings
 */
class ZCoreSettings extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'z_core_settings';
        $this->TableName = 'z_core_settings';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"z_core_settings\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('z_core_settings', 'z_core_settings', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, 4, -1, false, '"id"', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // name
        $this->name = new DbField('z_core_settings', 'z_core_settings', 'x_name', 'name', '"name"', '"name"', 200, 0, -1, false, '"name"', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // value
        $this->value = new DbField('z_core_settings', 'z_core_settings', 'x_value', 'value', '"value"', '"value"', 200, 0, -1, false, '"value"', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"z_core_settings\"";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->id->setDbValue($conn->fetchColumn("SELECT currval('core_settings_id_seq'::regclass)"));
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("zcoresettingslist");
        }
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ZCoreSettingsView";
            case Config("API_ADD_ACTION"):
                return "ZCoreSettingsAdd";
            case Config("API_EDIT_ACTION"):
                return "ZCoreSettingsEdit";
            case Config("API_DELETE_ACTION"):
                return "ZCoreSettingsDelete";
