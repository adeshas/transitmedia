...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'lBVDlgr78aP5pVd5', // Random key for encryption
    ...
    "ADMIN_PASSWORD" => "admintransit", // Administrator password
    ...
    // Email
    "SENDER_EMAIL" => "admin@transitmedia.com.ng", // Sender email address
    "RECIPIENT_EMAIL" => "adeshas@gmail.com", // Recipient email address
