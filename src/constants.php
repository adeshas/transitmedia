...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "17.0.6");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "test"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{7CA6B0F7-61EF-4DB7-A152-ED7AD2382C98}"); // Project ID
