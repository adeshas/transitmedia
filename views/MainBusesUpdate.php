...
loadjs.ready("head", function () {
    ...
    fmain_busesupdate.addFields([
        ...
        ["ts_last_update", [fields.ts_last_update.visible && fields.ts_last_update.required ? ew.Validators.required(fields.ts_last_update.caption) : null, ew.Validators.datetime(1), ew.Validators.selected], fields.ts_last_update.isInvalid]
    ]);
...
$Page->showMessage();
?>
<form name="fmain_busesupdate" id="fmain_busesupdate" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
