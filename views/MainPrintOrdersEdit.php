...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->approved->isInvalidClass() ?>" data-table="main_print_orders" data-field="x_approved" name="x_approved[]" id="x_approved_813711" value="1"<?= ConvertToBool($Page->approved->CurrentValue) ? " checked" : "" ?><?= $Page->approved->editAttributes() ?> aria-describedby="x_approved_help">
    <label class="custom-control-label" for="x_approved_813711"></label>
</div>
