...
<form name="fmain_print_orderslistsrch" id="fmain_print_orderslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fmain_print_orderslist" id="fmain_print_orderslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
