...
// Page object
$MainPrintOrdersView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fmain_print_ordersview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fmain_print_ordersview = currentForm = new ew.Form("fmain_print_ordersview", "view");
    loadjs.done("fmain_print_ordersview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fmain_print_ordersview" id="fmain_print_ordersview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_id"><?= $Page->id->caption() ?></span></td>
        <td data-name="id" <?= $Page->id->cellAttributes() ?>>
<span id="el_main_print_orders_id">
...
<?php if ($Page->campaign_id->Visible) { // campaign_id ?>
    <tr id="r_campaign_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_campaign_id"><?= $Page->campaign_id->caption() ?></span></td>
...
<?php if ($Page->printer_id->Visible) { // printer_id ?>
    <tr id="r_printer_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_printer_id"><?= $Page->printer_id->caption() ?></span></td>
...
<?php if ($Page->ts_created->Visible) { // ts_created ?>
    <tr id="r_ts_created">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_ts_created"><?= $Page->ts_created->caption() ?></span></td>
        <td data-name="ts_created" <?= $Page->ts_created->cellAttributes() ?>>
<span id="el_main_print_orders_ts_created">
...
<?php if ($Page->link->Visible) { // link ?>
    <tr id="r_link">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_link"><?= $Page->link->caption() ?></span></td>
        <td data-name="link" <?= $Page->link->cellAttributes() ?>>
<span id="el_main_print_orders_link">
...
<?php if ($Page->quantity->Visible) { // quantity ?>
    <tr id="r_quantity">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_quantity"><?= $Page->quantity->caption() ?></span></td>
...
<?php if ($Page->approved->Visible) { // approved ?>
    <tr id="r_approved">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_approved"><?= $Page->approved->caption() ?></span></td>
...
<?php if ($Page->comments->Visible) { // comments ?>
    <tr id="r_comments">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_comments"><?= $Page->comments->caption() ?></span></td>
...
<?php if ($Page->all_codes_assigned_in_campaign->Visible) { // all_codes_assigned_in_campaign ?>
    <tr id="r_all_codes_assigned_in_campaign">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_all_codes_assigned_in_campaign"><?= $Page->all_codes_assigned_in_campaign->caption() ?></span></td>
...
<?php if ($Page->bus_codes->Visible) { // bus_codes ?>
    <tr id="r_bus_codes">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_bus_codes"><?= $Page->bus_codes->caption() ?></span></td>
...
<?php if ($Page->available_codes_to_be_assigned->Visible) { // available_codes_to_be_assigned ?>
    <tr id="r_available_codes_to_be_assigned">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_main_print_orders_available_codes_to_be_assigned"><?= $Page->available_codes_to_be_assigned->caption() ?></span></td>
