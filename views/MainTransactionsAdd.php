...
loadjs.ready("head", function () {
    ...
    // Validate form
    fmain_transactionsadd.validate = function () {
    ...
    // Form_CustomValidate
    fmain_transactionsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmain_transactionsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
    ...
    loadjs.done("fmain_transactionsadd");
});
</script>
<script>
loadjs.ready("head", function () {
    // Client script
    var ext;$("#x_end_date").parent().on("change.datetimepicker",(function({date:e,oldDate:t}){var a=$("#x_start_date").parent().datetimepicker("date"),d=e;if(moment.isMoment(a)&&moment.isMoment(d)&&d.isAfter(a)){var n=d.diff(a,"days");$("#x_end_date_help").text(n+" days")}else $("#x_end_date_help").text("Please correct the dates")})),$("#x_start_date").parent().on("change.datetimepicker",(function({date:e,oldDate:t}){ext=e,moment.isMoment(e)&&$("#x_end_date").parent().datetimepicker("date",e.add(30,"days"))}));
});
</script>
...
<script>
loadjs.ready(["fmain_transactionsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fmain_transactionsadd", "x_payment_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmain_transactionsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fmain_transactionsadd", "x_start_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmain_transactionsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fmain_transactionsadd", "x_end_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
