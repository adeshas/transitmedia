...
<form name="fmain_transactionslistsrch" id="fmain_transactionslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fmain_transactionslist" id="fmain_transactionslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
