...
// Page object
$SubRenewalRequestsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fsub_renewal_requestsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fsub_renewal_requestsadd = currentForm = new ew.Form("fsub_renewal_requestsadd", "add");
    ...
    fsub_renewal_requestsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fsub_renewal_requestsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fsub_renewal_requestsadd.validate = function () {
    ...
    // Form_CustomValidate
    fsub_renewal_requestsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsub_renewal_requestsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fsub_renewal_requestsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fsub_renewal_requestsadd" id="fsub_renewal_requestsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fsub_renewal_requestsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fsub_renewal_requestsadd", "x_ts_created", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fsub_renewal_requestsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fsub_renewal_requestsadd", "x_ts_last_update", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
