...
$Page->showMessage();
?>
<form name="fsub_transaction_detailsdelete" id="fsub_transaction_detailsdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
