...
// Page object
$ViewBusExtSummaryAtAGlanceList = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fview_bus_ext_summary_at_a_glancelist;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "list";
    fview_bus_ext_summary_at_a_glancelist = currentForm = new ew.Form("fview_bus_ext_summary_at_a_glancelist", "list");
...
<form name="fview_bus_ext_summary_at_a_glancelistsrch" id="fview_bus_ext_summary_at_a_glancelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> view_bus_ext_summary_at_a_glance">
<?php if (!$Page->isExport()) { ?>
...
<?php } ?>
<form name="fview_bus_ext_summary_at_a_glancelist" id="fview_bus_ext_summary_at_a_glancelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="view_bus_ext_summary_at_a_glance">
<div id="gmp_view_bus_ext_summary_at_a_glance" class="<?= ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit()) { ?>
<table id="tbl_view_bus_ext_summary_at_a_glancelist" class="table ew-table"><!-- .ew-table -->
<thead>
...
<?php if ($Page->maintenance->Visible) { // maintenance ?>
        <th data-name="maintenance" class="<?= $Page->maintenance->headerCellClass() ?>"><div id="elh_view_bus_ext_summary_at_a_glance_maintenance" class="view_bus_ext_summary_at_a_glance_maintenance"><?= $Page->renderSort($Page->maintenance) ?></div></th>
<?php } ?>
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_view_bus_ext_summary_at_a_glance", "data-rowtype" => $Page->RowType]);
...
<span id="el<?= $Page->RowCount ?>_view_bus_ext_summary_at_a_glance_maintenance">
...
<span id="el<?= $Page->RowCount ?>_view_bus_ext_summary_at_a_glance_total">
...
loadjs.ready("head", function() {
    ew.addEventHandlers("view_bus_ext_summary_at_a_glance");
});
</script>
<script>
