...
<form name="fview_bus_int_summary_at_a_glancelistsrch" id="fview_bus_int_summary_at_a_glancelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fview_bus_int_summary_at_a_glancelist" id="fview_bus_int_summary_at_a_glancelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
