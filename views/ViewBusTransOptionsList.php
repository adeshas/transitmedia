...
<form name="fview_bus_trans_optionslistsrch" id="fview_bus_trans_optionslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<?php } ?>
<form name="fview_bus_trans_optionslist" id="fview_bus_trans_optionslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
