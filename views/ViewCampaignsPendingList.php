...
<form name="fview_campaigns_pendinglistsrch" id="fview_campaigns_pendinglistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fview_campaigns_pendinglist" id="fview_campaigns_pendinglist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
