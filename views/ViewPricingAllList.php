...
<form name="fview_pricing_alllistsrch" id="fview_pricing_alllistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fview_pricing_alllist" id="fview_pricing_alllist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
