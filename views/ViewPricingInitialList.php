...
<form name="fview_pricing_initiallistsrch" id="fview_pricing_initiallistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<?php } ?>
<form name="fview_pricing_initiallist" id="fview_pricing_initiallist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
