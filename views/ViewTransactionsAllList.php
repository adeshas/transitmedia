...
<form name="fview_transactions_alllistsrch" id="fview_transactions_alllistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<?php } ?>
<form name="fview_transactions_alllist" id="fview_transactions_alllist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
