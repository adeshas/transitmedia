...
loadjs.ready("head", function () {
    ...
    // Validate form
    fw_vendors_operatorsadd.validate = function () {
    ...
    // Form_CustomValidate
    fw_vendors_operatorsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fw_vendors_operatorsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fw_vendors_operatorsadd.lists.vendor_id = <?= $Page->vendor_id->toClientList($Page) ?>;
    fw_vendors_operatorsadd.lists.operator_id = <?= $Page->operator_id->toClientList($Page) ?>;
    loadjs.done("fw_vendors_operatorsadd");
});
</script>
<script>
loadjs.ready("head", function () {
