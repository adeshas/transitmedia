...
loadjs.ready("head", function () {
    ...
    // Set invalid fields
    $(function() {
        var f = fx_transaction_statusadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fx_transaction_statusadd.validate = function () {
    ...
    // Form_CustomValidate
    fx_transaction_statusadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fx_transaction_statusadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fx_transaction_statusadd");
});
</script>
<script>
loadjs.ready("head", function () {
