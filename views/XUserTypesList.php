...
<form name="fx_user_typeslistsrch" id="fx_user_typeslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<?php } ?>
<form name="fx_user_typeslist" id="fx_user_typeslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
