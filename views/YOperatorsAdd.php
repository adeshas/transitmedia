...
loadjs.ready("head", function () {
    ...
    fy_operatorsadd = currentForm = new ew.Form("fy_operatorsadd", "add");
    ...
    // Validate form
    fy_operatorsadd.validate = function () {
    ...
    // Form_CustomValidate
    fy_operatorsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fy_operatorsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fy_operatorsadd.lists.platform_id = <?= $Page->platform_id->toClientList($Page) ?>;
    loadjs.done("fy_operatorsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fy_operatorsadd" id="fy_operatorsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
