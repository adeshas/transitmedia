...
loadjs.ready("head", function () {
    ...
    fy_platformsadd = currentForm = new ew.Form("fy_platformsadd", "add");
    ...
    // Validate form
    fy_platformsadd.validate = function () {
    ...
    // Form_CustomValidate
    fy_platformsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fy_platformsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fy_platformsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fy_platformsadd" id="fy_platformsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
?>
<?php
    if (in_array("y_operators", explode(",", $Page->getCurrentDetailTable())) && $y_operators->DetailAdd) {
