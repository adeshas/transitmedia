...
loadjs.ready("head", function () {
    ...
    // Validate form
    fz_core_settingsadd.validate = function () {
    ...
    // Form_CustomValidate
    fz_core_settingsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fz_core_settingsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fz_core_settingsadd");
});
</script>
<script>
loadjs.ready("head", function () {
