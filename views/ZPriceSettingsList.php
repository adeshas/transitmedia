...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->active->isInvalidClass() ?>" data-table="z_price_settings" data-field="x_active" name="x_active[]" id="x_active_396236" value="1"<?= ConvertToBool($Page->active->AdvancedSearch->SearchValue) ? " checked" : "" ?><?= $Page->active->editAttributes() ?>>
    <label class="custom-control-label" for="x_active_396236"></label>
</div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->active->isInvalidClass() ?>" data-table="z_price_settings" data-field="x_active" name="x<?= $Page->RowIndex ?>_active[]" id="x<?= $Page->RowIndex ?>_active_539313" value="1"<?= ConvertToBool($Page->active->CurrentValue) ? " checked" : "" ?><?= $Page->active->editAttributes() ?>>
    <label class="custom-control-label" for="x<?= $Page->RowIndex ?>_active_539313"></label>
</div>
...
<span id="el<?= $Page->RowCount ?>_z_price_settings_active" class="form-group">
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->active->isInvalidClass() ?>" data-table="z_price_settings" data-field="x_active" name="x<?= $Page->RowIndex ?>_active[]" id="x<?= $Page->RowIndex ?>_active_341921" value="1"<?= ConvertToBool($Page->active->CurrentValue) ? " checked" : "" ?><?= $Page->active->editAttributes() ?>>
    <label class="custom-control-label" for="x<?= $Page->RowIndex ?>_active_341921"></label>
</div>
<div class="invalid-feedback"><?= $Page->active->getErrorMessage() ?></div>
</span>
<?php } ?>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->active->isInvalidClass() ?>" data-table="z_price_settings" data-field="x_active" name="x<?= $Page->RowIndex ?>_active[]" id="x<?= $Page->RowIndex ?>_active_717467" value="1"<?= ConvertToBool($Page->active->CurrentValue) ? " checked" : "" ?><?= $Page->active->editAttributes() ?>>
    <label class="custom-control-label" for="x<?= $Page->RowIndex ?>_active_717467"></label>
</div>
<div class="invalid-feedback"><?= $Page->active->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="z_price_settings" data-field="x_active" data-hidden="1" name="o<?= $Page->RowIndex ?>_active[]" id="o<?= $Page->RowIndex ?>_active[]" value="<?= HtmlEncode($Page->active->OldValue) ?>">
