...
$sideMenu->addMenuItem(201, "mi_print_orders", $MenuLanguage->MenuPhrase("201", "MenuText"), $MenuRelativePath . "printorderslist", 98, "", AllowListMenu('{7CA6B0F7-61EF-4DB7-A152-ED7AD2382C98}print_orders'), false, false, "fa-angle-double-right fas", "", false);
...
$sideMenu->addMenuItem(200, "mi_printers", $MenuLanguage->MenuPhrase("200", "MenuText"), $MenuRelativePath . "printerslist", 95, "", AllowListMenu('{7CA6B0F7-61EF-4DB7-A152-ED7AD2382C98}printers'), false, false, "fa-angle-double-right fas", "", false);
...
$sideMenu->addMenuItem(195, "mi_view_transactions_per_operator", $MenuLanguage->MenuPhrase("195", "MenuText"), $MenuRelativePath . "viewtransactionsperoperatorlist", -1, "", AllowListMenu('{7CA6B0F7-61EF-4DB7-A152-ED7AD2382C98}view_transactions_per_operator'), false, false, "fa-angle-double-right fas", "", false);
$sideMenu->addMenuItem(197, "mi_view_transactions_per_platform", $MenuLanguage->MenuPhrase("197", "MenuText"), $MenuRelativePath . "viewtransactionsperplatformlist", -1, "", AllowListMenu('{7CA6B0F7-61EF-4DB7-A152-ED7AD2382C98}view_transactions_per_platform'), false, false, "fa-angle-double-right fas", "", false);
$sideMenu->addMenuItem(198, "mi_view_campaigns_pending", $MenuLanguage->MenuPhrase("198", "MenuText"), $MenuRelativePath . "viewcampaignspendinglist", -1, "", AllowListMenu('{7CA6B0F7-61EF-4DB7-A152-ED7AD2382C98}view_campaigns_pending'), false, false, "fa-angle-double-right fas", "", false);
